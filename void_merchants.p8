...
function _update()
	...
	if travel_after_battle_mode then
		...
		-- -- phase three: jump
		-- if travel_after_battle_phase == 1 then
		-- 	sfx(13)
		-- -- phase two: engaging thrusters
		-- elseif travel_after_battle_phase == 2 then
		-- 	battle_mode = false
		-- 	show_battle_stats = false
		-- 	sfx(14)
		-- -- phase one: loading batteries
		-- elseif travel_after_battle_phase == 3 then
		-- 	sfx(15)
		-- end
		-- -- phase one: loading batteries. already happened
...
----------------
	...
	current_planet = 6
	-- sspr(planets[current_planet][1], planets[current_planet][2], 32, 32, 48, 48, 8*4, 8*4)
	-- current_small_planet = 5
	-- sspr(small_planets[current_small_planet][1], small_planets[current_small_planet][2], 16, 16, 8, 48, 8*4, 8*4)
...

...

__label__
...
34160020307103271033710377103a71037710327102e710307103271033710377103a71037710337103271030710327103771030710327103771030710327103071032710377103a7103c7103a7103771035710
...
5c160020187401874018740187401874018740187401874014740147401474014740147401474014740147400f7400f7400f7400f7400f7400f7400f7400f7401174011740117401174011740117401174011740
...
001e000004730047300473005730057300573006730067400674007740077400774008740087400875009750097500a7500a7500b7500b7500c7600c7600d7600d7600e7600f7601077011770127701377014770
...

