...
<p align="center">
    <a href="https://scatenix.github.io/Void-Merchants/" target="_blank">
    <img src="https://github.com/Scatenix/Void-Merchants/blob/main/resources/README/void-merchants.png" alt="Void Merchants - Click to play on the web" width="40%" />
    </a>
</p>
...
The game sound volume can be adjusted in the settings (pause button next to the bottom-right corner).
...
## Running the Game in PICO-8

Download this png and load it into PICO-8:
...
- `resources` - Contains all the exported PICO-8 files, images and GIFs for the README.md as well as all the needed files, including the font, for the game manual.
...
- Libre Office
- 7-Zip
- Public Pixel Font (Can be found in resources/fonts/PublicPixelFont)
